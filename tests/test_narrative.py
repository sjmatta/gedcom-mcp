...
class TestIndividualNotes:
    ...
    def test_some_individuals_have_notes(self):
        ...
        individuals_with_notes = sum(1 for indi in gs.individuals.values() if indi.notes)
    ...
    def test_biography_family_are_names(self):
        ...
        for indi in gs.individuals.values():
            if indi.family_as_child:
                result = gs._get_biography(indi.id)
...
class TestSearchNarrative:
    ...
    def test_search_returns_dict(self):
        ...
        result = gs._search_narrative("test")
        assert isinstance(result, dict)
            ...
            if indi.notes:
                ...
                if words:
                    ...
                    if len(word) > 3:  # Skip short words
                        result = gs._search_narrative(word)
    ...
    def test_search_case_insensitive(self):
        ...
        upper = gs._search_narrative("OBITUARY")
        lower = gs._search_narrative("obituary")
...
class TestCreateSnippet:
    ...
    def test_snippet_with_ellipsis(self):
        ...
        text = "A" * 100 + "MATCH" + "B" * 100
        snippet = gs._create_snippet(text, "match", context_chars=10)
        assert "..." in snippet
